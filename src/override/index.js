...
class WhichWayAPIOverride {
  ...
  async appendHook(apiName, { before, after }) {
    ...
    if (isAsync) {
      wrapped = async function(...args) {
        if (before) {
          ...
          if (beforeResult === false) return void 0;
    ...
    function isAsyncFunction(fn) {
      ...
      return fn[Symbol.toStringTag] === "AsyncFunction" || fn.constructor?.name === "AsyncFunction" || fn.toString().startsWith("async ") || fn.toString().startsWith("async function");
    }
  }
  /**
