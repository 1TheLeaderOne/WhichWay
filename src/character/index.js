...
class WhichWayCharacterPack {
    ...
    for (let folder of folders) {
      ...
      for (let file of folder.files) {
        if (file.name.endsWith(".js")) {
          module[1].push(await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./packs/epic/epic1.js": () => import("./packs/epic/epic1.js"), "./packs/epic/epic2.js": () => import("./packs/epic/epic2.js"), "./packs/especial/especial1SJZX.js": () => import("./packs/especial/especial1SJZX.js"), "./packs/legend/legend1SJZX.js": () => import("./packs/legend/legend1SJZX.js"), "./packs/legend/legend2SJZX.js": () => import("./packs/legend/legend2SJZX.js"), "./packs/legend/legend3SJZX.js": () => import("./packs/legend/legend3SJZX.js"), "./packs/mediocre/mediocre1SJZX.js": () => import("./packs/mediocre/mediocre1SJZX.js"), "./packs/normal/normal1SJZX.js": () => import("./packs/normal/normal1SJZX.js"), "./packs/plot/plot1SJZX.js": () => import("./packs/plot/plot1SJZX.js"), "./packs/rare/rare1SJZX.js": () => import("./packs/rare/rare1SJZX.js"), "./packs/special/special1SJZX.js": () => import("./packs/special/special1SJZX.js") }), `./packs/${folder.name}/${whichWayFile.removeExt(file.name)}.js`, 4).then((res) => res.default));
        }
      }
  ...
  async setImportModule(packname) {
    var names = Object.keys(packname.character).filter(
      (key) => key.endsWith("mrfz") && /** @ts-ignore */
