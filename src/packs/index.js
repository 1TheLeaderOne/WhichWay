    ...
    for (const folder of folders) {
      ...
      for (const file of folder.files) {
        try {
          ...
          await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./character/beiluoneimrfz/index.ts": () => import("./character/beiluoneimrfz/index.js"), "./character/botanimrfz/index.ts": () => import("./character/botanimrfz/index.js"), "./character/fengxumrfz/index.ts": () => import("./character/fengxumrfz/index.js"), "./character/fuzoumrfz/index.ts": () => import("./character/fuzoumrfz/index.js"), "./character/gallusmrfz/index.ts": () => import("./character/gallusmrfz/index.js"), "./character/jiemrfz/index.ts": () => import("./character/jiemrfz/index.js"), "./character/jumrfz/index.ts": () => import("./character/jumrfz/index.js"), "./character/keluxiermrfz/index.ts": () => import("./character/keluxiermrfz/index.js"), "./character/liexiangmrfz/index.ts": () => import("./character/liexiangmrfz/index.js"), "./character/migelumrfz/index.ts": () => import("./character/migelumrfz/index.js"), "./character/sbchenmrfz/index.ts": () => import("./character/sbchenmrfz/index.js"), "./character/spkaierximrfz/index.ts": () => import("./character/spkaierximrfz/index.js"), "./character/spkongbaomrfz/index.ts": () => import("./character/spkongbaomrfz/index.js"), "./character/splingdongmrfz/index.ts": () => import("./character/splingdongmrfz/index.js"), "./character/spzilanmrfz/index.ts": () => import("./character/spzilanmrfz/index.js"), "./character/taojinniangmrfz/index.ts": () => import("./character/taojinniangmrfz/index.js"), "./character/wangmrfz/index.ts": () => import("./character/wangmrfz/index.js"), "./character/weiyimrfz/index.ts": () => import("./character/weiyimrfz/index.js"), "./character/wujiumrfz/index.ts": () => import("./character/wujiumrfz/index.js") }), `./character/${folder.name}/index.ts`, 4);
        }
      }
    }
    this.register();
