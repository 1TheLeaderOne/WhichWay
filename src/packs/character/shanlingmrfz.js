  ...
  "lichangmrfz": {
    ...
    subSkill: {
      ...
      da: {
        ...
        async content(event, trigger, player) {
          let result;
          result = await player.chooseTarget(get.prompt("lichangmrfz"), "【力场】:你可以选择三名角色，令其各从牌堆或弃牌堆中获得一张装备牌", [1, 3]).set("ai", (target) => {
          ...
          while (event.num < event.num2) {
            ...
            result = await currentTarget.chooseTarget(str, (card2, player2, target) => {
