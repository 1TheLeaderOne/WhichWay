...
character("feilaimrfz", { pack: "epicSJZX", sex: "female", group: "samrfz", hp: 5, skills: ["qianxiumrfz", "mingzhoumrfz"] });
	...
	mingzhoumrfz: {
		...
		async content(event, trigger, player) {
			player.chooseToDiscard({
				position:"he",
				forced:true,
				prompt:`请弃置${trigger.cards.length}张牌`,
				selectCard() {
					return trigger.cards.length;
				},
				filterCard:()=>true
