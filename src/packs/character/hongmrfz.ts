...
character("hongmrfz", { pack: "epicSJZX", sex: "female", group: "luomrfz", hp: 4, skills: ["qunlangmrfz", "cigumrfz", "qingchumrfz"], hasHiddenSkill: true });
...
skill({
	...
	cigumrfz: {
		...
		prompt: function (event, player) {
			let cards = event.cards.filterInD("o").filterInD("d");
