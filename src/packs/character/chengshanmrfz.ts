...
character("chengshanmrfz", { pack: "legendSJZX", sex: "female", group: "luomrfz", hp: 3, skills: ["dianshanmrfz", "shidemrfz"] });
	...
	dianshanmrfz: {
		...
		async content(event, trigger, player) {
			...
			if (player.storage.dianshanmrfz == true) {
				result = await player
					.chooseTarget({
						prompt: get.prompt("dianshanmrfz"),
						prompt2: "对一名其他角色造成一点雷属性伤害",
						forced: true,
