...
character("chizuimrfz", { pack: "legendSJZX", sex: "female", group: "xumrfz", hp: 4, skills: ["newzhidianmrfz", "newpijimrfz"] });
				...
				case "选项二": {
					...
					if (skillList.length > 0) {
						let result = await player
							.chooseControl({ controls: skillList })
