...
character("bobumrfz", { pack: "epicSJZX", sex: "male", group: "gemrfz", hp: 4, skills: ["qingtingmrfz", "qingtanmrfz"] });
			...
			const result2 =
				tHs.length < 2
					...
					: await target
							...
							.set("target", player)
							.forResult();
			const [cards1, cards2] = [result1.cards, result2.cards];
			if (cards1 && cards2) {
