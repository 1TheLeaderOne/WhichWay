...
skill({
  ...
  "huanghunmrfz": {
    ...
    check: function(event, player) {
      ...
      if (player.countCards("j") > 0 && !player.hasCard(function(card) {
    ...
    async content(event, trigger, player) {
      const result = await player.chooseToDiscard("he", "【黄昏】:你可以至多弃置两张牌，然后增加等量的体力上限", [0, 2]).set("ai", function(card) {
...
//# sourceMappingURL=semrfz.js.map
