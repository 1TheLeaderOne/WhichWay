  ...
  "chongcimrfz": {
    ...
    init(player) {
      game.broadcastAll(function(name) {
        ["retieji", "yimie"].forEach((skill2) => {
          if (!lib.skill[skill2].audioname2) lib.skill[skill2].audioname2 = {};
          lib.skill[skill2].audioname2[name] = "chongcimrfz";
        });
      }, player.name);
