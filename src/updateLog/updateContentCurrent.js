...
let info = {
	intro: [
		"新增干员：可露希尔、乌啾、维伊、怒潮凛冬、裂响、伯塔尼、雷狼龙S空爆、GALLUS²",
		...
		"修复星源【导流】因AI修复导致的bug",
		"修复傀影【血歌】因AI修复导致的bug",
		"修复折桠【寒生】由于chooseUseTarget传参变更导致的bug",
		"修复斩业星熊【斩业】由于chooseUseTarget传参变更导致的bug",
		"修复黑键【寂音】由于chooseUseTarget传参变更导致的bug",
		"修复歌蕾蒂娅【寻相】使用已经被废弃的api导致的bug",
		"修复隐德来希【平漪】在部分情况下会报错的bug",
	...
	player: ["keluxiermrfz","weiyimrfz","wujiumrfz","splingdongmrfz","liexiangmrfz","botanimrfz","spkongbaomrfz","gallusmrfz"],
	cards: [],
};
