class WhichWayHooks {
  ...
  _registerHook(hookKey, fn) {
    if (typeof fn === "function") {
      fn = { fn };
    } else if (typeof fn === "object" && fn.fn === void 0 && typeof fn.obj === "object") {
      if (fn.obj.name === void 0) throw new Error(`[WhichWayHooks] Invalid config hook return object, missing "name" property: ${fn.obj}`);
    } else if (typeof fn !== "object" || fn.fn === void 0) {
...
const { onSetDev, onExtension, onArenaReady, onContent, onBeforeContent, onConfig, onInit, onAfterInit, whichWayHooksApi, registerHookContextAt } = exportsMethods;
onSetDev({
